...
class ControlStateMachine(secsgem.common.StateMachine):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        self.init = secsgem.common.State(ControlState.INIT, "INIT")
        ...
        self._transitions: list[secsgem.common.Transition] = [
            ...
            secsgem.common.Transition(
                "attempt_online_fail_equipment_offline", self.attempt_online, self.equipment_offline
            ),  # 4
            ...
            secsgem.common.Transition(
                "switch_offline", [self.online, self.online_local, self.online_remote], self.equipment_offline
            ),  # 6, 12
            ...
            secsgem.common.Transition(
                "remote_offline", [self.online, self.online_local, self.online_remote], self.host_offline
            ),  # 10
